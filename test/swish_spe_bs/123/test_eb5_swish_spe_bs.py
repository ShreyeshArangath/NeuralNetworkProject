...
# batchSize: 64 if ResNet, 32 for others
# modelName: <modelname>
...
def getDataset(dataFolder, imageSize = (456, 456), batchSize = 32):
...
model = keras.Model(inp, out, name="FeatureExtraction-EfficientNetB5")
