...
def getDataset(dataFolder, subset, imageSize = (600, 600), batchSize = 32):
...
baseModel = EfficientNetB7(weights="imagenet",
                   include_top = False) 
...
model = keras.Model(inp, out, name="FeatureExtraction-B7")
